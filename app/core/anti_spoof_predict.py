...
class Detection:
    def __init__(self):
        ...
        model_dir = os.path.join(base_dir, "..", "models", "face", "detection_model")

        # Resolve full paths
        caffemodel = os.path.normpath(os.path.join(model_dir, "Widerface-RetinaFace.caffemodel"))
        deploy = os.path.normpath(os.path.join(model_dir, "deploy.prototxt"))

        print(f"OS CAMINHOS: 1 - {caffemodel} 2- {deploy}")
